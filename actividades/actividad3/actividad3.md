...
Los hyperscalers son proveedores de servicios en la nube a gran escala. Su rol en el ecosistema de la nube es fundamental, ya que ofrecen la infraestructura, capacidad de cómputo y servicios necesarios para escalar aplicaciones de forma rápida, flexible y global.
# Estudio de casos
...
| Modelo                      | Ejemplos de proveedores/herramientas                                             |
|-----------------------------|-----------------------------------------------------------------------------------|
| **IaaS (Infraestructura como Servicio)** | 1. Amazon EC2 (AWS)  <br> 2. Microsoft Azure Virtual Machines  <br> 3. Google Compute Engine |
| **PaaS (Plataforma como Servicio)**      | 1. Heroku  <br> 2. Google App Engine  <br> 3. Azure App Service                        |
| **SaaS (Software como Servicio)**        | 1. Google Workspace (Gmail, Drive, Docs)  <br> 2. Microsoft 365  <br> 3. Salesforce     |
| **DaaS (Escritorio como Servicio)**      | 1. Amazon WorkSpaces  <br> 2. Citrix Virtual Apps and Desktops  <br> 3. Microsoft Windows 365 |
## Nube Pública
